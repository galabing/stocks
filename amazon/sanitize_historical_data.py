...
""" Sanitizes historical stock data, extracts price and volume,
    skips the files with unfillable holes (for now more than one
    consecutive open dates missing).
"""
